...
<table class='table table-sm table-responsive' style="height: auto; width: auto">
    <thead>
        ...
        <th style='width: 30%; background-color: #99D9F2; color: white; line-height: 100%'
...
<table class='table table-sm table-responsive' style="height: auto; width: auto">
    <thead>
        <th style='width: 10%; background-color: #99D9F2; color: white; ' scope='col'
            align='center'>
            <center>DATE</center>
        </th>
        ...
        <th style='width: 10%; background-color: #99D9F2; color: white; line-height: 100%'
            scope='col' align='center'>
            <center> STATUS</center>
        </th>
...
async function autoInicioOrdenes() {
  try {
    const url = 'http://129.146.29.203:8080/api/order/zona/' + sessionStorage.getItem('zona')
...
async function consultOrder(id) {
  ...
  try {
    ...
    // debugger
    const url = 'http://129.146.29.203:8080/api/order/' + id
    // console.log(url)
    const response = await fetch(url);
...
async function updateOrder(id) {
    ...
    try {
      const urlUpdate = 'http://129.146.29.203:8080/api/order/update'
