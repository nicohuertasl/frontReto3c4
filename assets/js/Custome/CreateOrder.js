...
async function addOrder() {
  ...
  try {
    const ip_publica  = "http://129.146.29.203:";
    const puerto = "8080";
    const endpoint = "/api/cleaningprod/";
    //const url = ip_publica + puerto+ endpoint + 'all'
...
//autoincremento
    const urlOrder = 'http://129.146.29.203:8080/api/order/all'
    // console.log(url)
...
// fin autoincremento
    ...
    const urlSave = 'http://129.146.29.203:8080/api/order/new'
